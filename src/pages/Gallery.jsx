...
const IMAGES = {
  all: [
    {
      id: 1,
      caption: "Adventures & Memories 🌍📸",
      photos: [
        `${import.meta.env.BASE_URL}gallery/pic1.jpg`,
        `${import.meta.env.BASE_URL}gallery/pic2.jpg`,
        `${import.meta.env.BASE_URL}gallery/pic3.jpg`,
        `${import.meta.env.BASE_URL}gallery/pic4.jpg`,
      ],
    },
  ],
};
